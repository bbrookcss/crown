...
function add_css(target) {
  append_styles(target, "svelte-hpqpx9", "div.svelte-hpqpx9{position:static;cursor:zoom-in}.svelte-lightbox-thumbnail > *{max-width:100%;height:auto}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      toggle_class(div, "svelte-hpqpx9", true);
...
function add_css2(target) {
  append_styles(target, "svelte-5qj430", "div.svelte-lightbox-header.svelte-5qj430{width:auto;height:3rem;display:flex;justify-content:flex-end;align-items:center}div.svelte-lightbox-header.fullscreen.svelte-5qj430{position:fixed;z-index:5;top:0;left:0;right:0}button.svelte-5qj430{background:transparent;font-size:3rem;border:none;color:white}button.svelte-5qj430:hover{color:lightgray;cursor:pointer}button.svelte-5qj430:active{background-color:transparent}button.fullscreen.svelte-5qj430{filter:drop-shadow(0 0 5px black) drop-shadow(0 0 10px black)}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      toggle_class(button, "svelte-5qj430", true);
...
function create_fragment3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      toggle_class(div, "svelte-5qj430", true);
...
function add_css3(target) {
  append_styles(target, "svelte-1d3ym4l", "div.svelte-lightbox-body.svelte-1d3ym4l{position:relative;width:auto;height:auto;max-height:80vh}div.svelte-lightbox-body > *{max-width:100%;max-height:inherit;height:auto;width:auto;object-fit:contain}div.svelte-lightbox-body.scroll > *{max-height:100%}div.svelte-lightbox-body.expand > *{flex-grow:1}div.fullscreen.svelte-1d3ym4l{width:inherit;max-width:inherit;height:inherit;max-height:100%;display:flex;align-items:center;justify-content:center}div.scroll.svelte-1d3ym4l{overflow:scroll}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_fragment4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "svelte-lightbox-body svelte-1d3ym4l");
      toggle_class(
        div,
        "fullscreen",
        /*imagePreset*/
...
function add_css4(target) {
  append_styles(target, "svelte-6fc1ka", "div.svelte-lightbox-footer.svelte-6fc1ka{width:100%;height:auto;color:white;text-align:left;position:absolute}div.svelte-lightbox-footer.fullscreen.svelte-6fc1ka{position:fixed;z-index:5;bottom:0;left:0;right:0;padding-left:1rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_fragment5(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      ...
      html_tag_1 = claim_html_tag(h5_nodes, false);
    ...
    h: function hydrate() {
      ...
      toggle_class(div, "svelte-6fc1ka", true);
...
function add_css5(target) {
  append_styles(target, "svelte-7wg54p", `div.svelte-lightbox-overlay.svelte-7wg54p{position:fixed;z-index:1000000!important;background-color:rgba(43, 39, 45, 0.87);top:0;bottom:0;left:0;right:0;overflow:hidden;width:100%;height:100%;display:flex;align-items:center;justify-content:center}div.svelte-lightbox-overlay.svelte-7wg54p::before{content:'';position:absolute;top:0;bottom:0;left:0;right:0;opacity:0;z-index:-1}div.svelte-lightbox-overlay.svelte-7wg54p::after{content:"";clear:both;display:table}
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`);
}
function create_fragment6(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      set_attributes(div, div_data);
      toggle_class(div, "svelte-7wg54p", true);
...
function add_css6(target) {
  append_styles(target, "svelte-891jqp", "div.svelte-lightbox-main.svelte-891jqp{position:relative;max-width:100%;max-height:100%;height:auto;width:auto;background-color:transparent}div.svelte-lightbox-main.fullscreen.svelte-891jqp{height:inherit;width:inherit;max-height:inherit;max-width:inherit}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_fragment7(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      toggle_class(div, "svelte-891jqp", true);
...
function add_css7(target) {
  append_styles(target, "svelte-w1dh06", "button.svelte-w1dh06{background:transparent;border:none;font-size:1rem;width:50%;height:100%}button.svelte-w1dh06:active{background:transparent}button.svelte-w1dh06:disabled{color:gray}button:disabled.hideDisabled.svelte-w1dh06{visibility:hidden}svg.svelte-w1dh06{height:5rem}.previous-button.svelte-w1dh06{position:absolute;top:0;bottom:0;left:0;right:50%;z-index:4;text-align:left}.arrow.svelte-w1dh06{fill:none;stroke:var(--svelte-lightbox-arrows-color);stroke-linecap:round;stroke-linejoin:bevel;stroke-width:1.5px;margin:10px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_fragment9(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path, "class", "arrow svelte-w1dh06");
...
function add_css8(target) {
  append_styles(target, "svelte-1a1bwoj", "button.svelte-1a1bwoj{background:transparent;border:none;font-size:1rem;width:50%;height:100%}button.svelte-1a1bwoj:active{background:transparent}button.svelte-1a1bwoj:disabled{color:gray}button:disabled.hideDisabled.svelte-1a1bwoj{visibility:hidden}svg.svelte-1a1bwoj{height:5rem}.next-button.svelte-1a1bwoj{position:absolute;top:0;bottom:0;right:0;z-index:4;text-align:right}.arrow.svelte-1a1bwoj{fill:none;stroke:var(--svelte-lightbox-arrows-color);stroke-linecap:round;stroke-linejoin:bevel;stroke-width:1.5px;margin:10px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_fragment10(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(path, "class", "arrow svelte-1a1bwoj");
      add_location(path, file9, 9, 12, 331);
      add_location(g, file9, 8, 8, 315);
      attr_dev(svg, "viewBox", "0 0 24 24");
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      attr_dev(svg, "class", "svelte-1a1bwoj");
      add_location(svg, file9, 7, 4, 246);
      button.disabled = button_disabled_value = /*character*/
      ctx[2] !== "loop" && /*activeImage*/
      ctx[1] === /*imageCount*/
      ctx[0] - 1;
      attr_dev(button, "class", "next-button svelte-1a1bwoj");
      toggle_class(
        button,
        "hideDisabled",
        /*character*/
...
function add_css9(target) {
  append_styles(target, "svelte-hpqpx9", "div.svelte-hpqpx9{position:static;cursor:zoom-in}.svelte-lightbox-thumbnail > *{max-width:100%;height:auto}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function add_css10(target) {
  append_styles(target, "svelte-nn7ulo", "\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiR2FsbGVyeUltYWdlLnN2ZWx0ZSIsIm1hcHBpbmdzIjoiIiwibmFtZXMiOltdLCJpZ25vcmVMaXN0IjpbXSwic291cmNlcyI6WyIvVXNlcnMvbmFob21lL2Nyb3duL25vZGVfbW9kdWxlcy9zdmVsdGUtbGlnaHRib3gvZGlzdC9HYWxsZXJ5L0dhbGxlcnlJbWFnZS5zdmVsdGUiXX0= */");
}
